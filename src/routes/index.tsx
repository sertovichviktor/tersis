...
import { Truck, ArrowRight, Menu, X, Phone, Mail, MapPin, Globe, Shield, Clock, FileText, Maximize2, Users } from 'lucide-react'
...
function TersisApp() {
  ...
  // ОПТИМИЗИРОВАННЫЙ СКРОЛЛ: Не вызывает рендер, если значение не изменилось
  useEffect(() => {
    const handleScroll = () => {
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-10">
            ...
            <div className="p-10 bg-[#0a1628] rounded-3xl border border-blue-500/20">
              ...
              <p className="text-gray-400 text-sm mb-4">105 m³ • 3.0 m Height • MEGA High Volume</p>
