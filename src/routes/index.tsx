...
// --- 2. ИЗОЛЯЦИЯ: КАРТА (Теперь она точно определена!) ---
...
function TersisApp() {
  ...
  return (
    <div className="bg-[#050a14] text-white min-h-screen overflow-x-hidden font-sans">
      {/* NAVIGATION */}
      <nav className={`fixed w-full z-50 transition-all ${isScrolled ? 'bg-[#050a14]/98 border-b border-white/5' : 'bg-transparent'}`}>
        <div className="max-w-7xl mx-auto flex justify-between items-center px-6 h-20 text-white">
          <div className="flex items-center gap-2 cursor-pointer" onClick={() => window.scrollTo({top:0, behavior:'smooth'})}>
            <img src="/logo.png" className="h-10" alt="Logo" /><span className="font-black text-2xl tracking-tighter uppercase">TERSIS</span>
          </div>
      ...
      <section id="about" className="py-24 px-6 bg-[#050a14] border-t border-white/5 text-center">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-gray-400 text-lg leading-relaxed">
            Reliable partner since 2011. License: <span className="text-white font-bold">LIC-009666-EBKR</span>.
          </p>
        </div>
      </section>
            ...
            <form onSubmit={handleSubmit} className="space-y-6" autoComplete="off">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8 text-white">
                <div>
                  ...
                  <input name="cargoType" placeholder="Electronics..." autoComplete="one-time-code" className="w-full bg-[#0a1628] border border-white/5 rounded-xl px-5 py-4 outline-none focus:border-blue-500" />
                </div>
                <div>
